...
class ApiReportGenerator {
    ...
    static generateReviewFileContent(collector) {
            ...
            if (entity.exported) {
                ...
                if (entity.astEntity instanceof AstSymbol_1.AstSymbol) {
                    ...
                    for (const astDeclaration of entity.astEntity.astDeclarations || []) {
                        ...
                        const fetchedMessages = collector.messageRouter
        ...
        const unassociatedMessages = collector.messageRouter
            ...
            for (const child of span.children) {
                ...
                if (AstDeclaration_1.AstDeclaration.isSupportedSyntaxKind(child.kind)) {
                    ...
                    if (!insideTypeLiteral) {
                        const messagesToReport = collector.messageRouter
    ...
    static _getAedocSynopsis(collector, astDeclaration, messagesToReport) {
        ...
        if (!symbolMetadata.releaseTagSameAsParent) {
            if (symbolMetadata.releaseTag !== api_extractor_model_1.ReleaseTag.None) {
                footerParts.push(api_extractor_model_1.ReleaseTag.getTagName(symbolMetadata.releaseTag));
            }
        }
