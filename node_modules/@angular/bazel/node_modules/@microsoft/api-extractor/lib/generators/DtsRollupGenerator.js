    ...
    static _generateTypingsFileContent(collector, stringWriter, dtsKind) {
        ...
        for (const entity of collector.entities) {
            if (entity.astEntity instanceof AstImport_1.AstImport) {
                ...
                const releaseTag = symbolMetadata ? symbolMetadata.releaseTag : api_extractor_model_1.ReleaseTag.None;
        ...
        for (const entity of collector.entities) {
            const symbolMetadata = collector.tryFetchMetadataForAstEntity(entity.astEntity);
            const releaseTag = symbolMetadata ? symbolMetadata.releaseTag : api_extractor_model_1.ReleaseTag.None;
            if (!this._shouldIncludeReleaseTag(releaseTag, dtsKind)) {
