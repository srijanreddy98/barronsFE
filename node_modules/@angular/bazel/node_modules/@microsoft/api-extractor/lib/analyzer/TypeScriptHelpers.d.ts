...
export declare class TypeScriptHelpers {
     ...
     */
    static hasAnyDeclarations(symbol: ts.Symbol): boolean;
    /**
    ...
    static getModuleSpecifier(declarationWithModuleSpecifier: ts.ImportDeclaration | ts.ExportDeclaration): string | undefined;
    /**
     ...
     */
    static isWellKnownSymbolName(name: string): boolean;
     ...
     */
    static isUniqueSymbolName(name: string): boolean;
    /**
