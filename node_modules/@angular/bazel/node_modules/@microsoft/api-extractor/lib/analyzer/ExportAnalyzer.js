...
class ExportAnalyzer {
    constructor(program, typeChecker, astSymbolTable) {
                    ...
                    if (TypeScriptHelpers_1.TypeScriptHelpers.hasAnyDeclarations(followedSymbol)) {
                        ...
                        if (!astSymbol) {
                            throw new Error(`Unsupported export ${JSON.stringify(exportedSymbol.name)} in `
                                + TypeScriptMessageFormatter_1.TypeScriptMessageFormatter.formatFileAndLineNumber(followedSymbol.declarations[0]));
                        }
