...
const TypeScriptMessageFormatter_1 = require("./TypeScriptMessageFormatter");
...
class TypeScriptHelpers {
     ...
     */
    static hasAnyDeclarations(symbol) {
    ...
    static getSymbolForDeclaration(declaration, checker) {
        ...
        if (!symbol) {
            throw new Error(TypeScriptMessageFormatter_1.TypeScriptMessageFormatter.formatFileAndLineNumber(declaration) + ': '
    ...
    static getModuleSpecifier(declarationWithModuleSpecifier) {
        if (declarationWithModuleSpecifier.moduleSpecifier
            && ts.isStringLiteralLike(declarationWithModuleSpecifier.moduleSpecifier)) {
            return TypeScriptInternals_1.TypeScriptInternals.getTextOfIdentifierOrLiteral(declarationWithModuleSpecifier.moduleSpecifier);
        }
        return undefined;
    }
    /**
     ...
     */
    static isWellKnownSymbolName(name) {
