...
export declare type AstEntity = AstSymbol | AstImport;
/**
...
export declare class AstSymbolTable {
    ...
    private readonly _entitiesByIdentifierNode;
    constructor(program: ts.Program, typeChecker: ts.TypeChecker, packageJsonLookup: PackageJsonLookup, messageRouter: MessageRouter);
    /**
     ...
     */
    tryGetEntityForIdentifierNode(identifier: ts.Identifier): AstEntity | undefined;
    /**
